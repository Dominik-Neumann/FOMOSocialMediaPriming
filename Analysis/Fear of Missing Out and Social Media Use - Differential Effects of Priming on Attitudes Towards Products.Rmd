...
### CELL SIZES
nrow(dat)
factorialdesign <- xtabs(~condition + product, data = dat)
...
summary(dat$age)
# Gender
print(xtabs(~gender + product + condition, data = dat))
# Race
print(xtabs(~race + product + condition, data = dat))
# Education
print(xtabs(~education + product + condition, data = dat))
# Income
print(xtabs(~income + product + condition, data = dat))
```
...
interact_plot(lm_interaction_overall,
              pred = participation.constr_std, modx = fomo.constr_std, mod2 = condition,
              x.label = "Instagram participation",
              y.label = "Attitude toward product",
              pred.labels = "Instagram participation",
              modx.labels = "FOMO",
              mod2.labels = c("No priming condition", "Priming condition"),
              colors = "Qual3")
```
#### Subsetting
```{r}
...
jnplot_prime <- johnson_neyman(lm_interaction_prime,
                               pred  = participation.constr_std, modx  = fomo.constr_std,
                               alpha = .05, sig.color = "#797979", insig.color = "#DEDEDE")
jnplot_prime
jnplot_prime$plot +
  ggtitle("Johnson-Neyman plot for primed participants") +
  xlab("FOMO") +
  ylab("Instagram participation")
```
...
jnplot_noprime
jnplot_noprime$plot +
  ggtitle("Johnson-Neyman plot for not primed participants") +
  xlab("FOMO") +
  ylab("Instagram participation")
```
```{r results = FALSE}
